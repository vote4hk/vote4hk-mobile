...
class OpenGraphParser {
  ...
  static Future<Map<String, dynamic>> getOpenGraphData(String url) async {
    ...
    try {
      ...
      response = await http.get('https://cors-anywhere.herokuapp.com/' + url);
    } catch (e) {
      print(e);
    }
  ...
  static String _scrapeAlternateToEmptyValue(
    ...
    if (tagTitle == "title" && document.head.getElementsByTagName("title").length > 0) {
